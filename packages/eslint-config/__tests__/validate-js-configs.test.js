...
describe('Validate JS configs', () => {
  it('Validate narcissus-fe-eslint-config', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/es5', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/vue', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/node', async () => {
