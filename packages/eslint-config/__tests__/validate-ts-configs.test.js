...
describe('Validate TS configs', () => {
  it('Validate narcissus-fe-eslint-config/typescript', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate narcissus-fe-eslint-config/typescript/node', async () => {
